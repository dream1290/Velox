...
vlx_window_setup_actions_and_menu (VlxWindow *self)
{
    static const GActionEntry entries[] = {
        { "open-file",       act_open_file,      NULL, NULL, NULL },
        { "open-url",        act_open_url,       NULL, NULL, NULL },
        { "play-pause",      act_play_pause,     NULL, NULL, NULL },
        { "stop",            act_stop,           NULL, NULL, NULL },
        { "fullscreen",      act_fullscreen,     NULL, NULL, NULL },
        { "screenshot",      act_screenshot,     NULL, NULL, NULL },
        ...
        { "speed-reset",     act_speed_reset,    NULL, NULL, NULL },
    };
